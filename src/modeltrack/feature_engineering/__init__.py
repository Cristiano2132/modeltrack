...
(binagem, encoding e pipeline de features).

Submódulos:
-----------
- binning: classes para discretização de variáveis contínuas (e.g. TreeBinner, CutBinner)
- encoder: classes para encoders estatísticos (e.g. WOEEncoder)
